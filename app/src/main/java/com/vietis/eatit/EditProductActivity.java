...
public class EditProductActivity extends AppCompatActivity {
    ...
    private void loadDetailsProduct() {
        ...
        reference.child(Objects.requireNonNull(firebaseAuth.getUid())).child("Products").child(productId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        String title = (String) snapshot.child("productTitle").getValue();
                        String description = (String) snapshot.child("productDescription").getValue();
                        String category = (String) snapshot.child("productCategory").getValue();
                        String quantity = (String) snapshot.child("productQuantity").getValue();
                        String icon = (String) snapshot.child("productIcon").getValue();
                        String price = (String) snapshot.child("originalPrice").getValue();
                        String discountPrice = (String) snapshot.child("discountPrice").getValue();
                        String discountNote = (String) snapshot.child("discountNote").getValue();
                        boolean discountAvailable = (boolean) snapshot.child("discountAvailable").getValue();
                        ...
                        try {
                            Picasso.get().load(icon).placeholder(R.drawable.ic_add_shopping_white)
                                    .into(productIconIv);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
    ...
    private void updateProduct() {
        ...
        if (image_uri == null) {
            ...
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
            reference.child(Objects.requireNonNull(firebaseAuth.getUid())).child("Products").child(productId).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            progressDialog.dismiss();
                            Toast.makeText(EditProductActivity.this, "Products updated", Toast.LENGTH_SHORT).show();
                            ...
                            if (uriTask.isSuccessful()) {
                                ...
                                reference.child(Objects.requireNonNull(firebaseAuth.getUid())).child("Products").child(productId).updateChildren(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                progressDialog.dismiss();
                                                Toast.makeText(EditProductActivity.this, "Products added", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(EditProductActivity.this, MainSellerActivity.class));
                                                finish();
                                            }
                                        })
